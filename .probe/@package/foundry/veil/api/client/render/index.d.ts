...
declare module "@package/foundry/veil/api/client/render" {
     ...
     */
    export type $VeilShaderBufferLayout_<T> = RegistryTypes.VeilShaderBuffer | { fields?: $Map_<string, $VeilShaderBufferLayout$FieldSerializer_<any>>, structSpecifier?: $GlslStructSpecifier, requestedBinding?: $ShaderBlock$BufferBinding_, memoryLayout?: $ShaderBlock$MemoryLayout_, name?: string,  } | [fields?: $Map_<string, $VeilShaderBufferLayout$FieldSerializer_<any>>, structSpecifier?: $GlslStructSpecifier, requestedBinding?: $ShaderBlock$BufferBinding_, memoryLayout?: $ShaderBlock$MemoryLayout_, name?: string, ];
