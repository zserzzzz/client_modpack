...
declare module "@package/com/jesz/createdieselgenerators/compat/kubejs" {
    export class $LighterSkinsEventJS implements $KubeEvent {
        /**
         * Removes a new lighter skin
         */
        remove(arg0: string, arg1: string): void;
        /**
         ...
         */
        success(): $Object;
        static removedIds: $Map<string, string>;
        static addedIds: $Map<string, string>;
        constructor();
    }
    ...
    export class $MoldEventJS implements $KubeStartupEvent {
        /**
