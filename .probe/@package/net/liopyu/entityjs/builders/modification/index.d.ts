...
declare module "@package/net/liopyu/entityjs/builders/modification" {
    export class $ModifyLivingEntityBuilder extends $ModifyEntityBuilder {
         ...
         *     ```
         */
        positionRider(arg0: $Consumer_<$ContextUtils$PositionRiderContext>): $ModifyLivingEntityBuilder;
        /**
         ...
         * ```
         */
        setSwimSplashSound(arg0: $Object): $ModifyLivingEntityBuilder;
        /**
         ...
         * ```
         */
        repositionEntityAfterLoad(arg0: boolean): $ModifyLivingEntityBuilder;
        /**
