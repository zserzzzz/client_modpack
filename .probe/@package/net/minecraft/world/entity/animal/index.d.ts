...
import { $SheepAccessor } from "@package/net/mehvahdjukaar/polytone/mixins/accessor";
import { $AttributeSupplier$Builder } from "@package/net/minecraft/world/entity/ai/attributes";
import { $UUID_, $Stack, $Map, $UUID, $List } from "@package/java/util";
...
declare module "@package/net/minecraft/world/entity/animal" {
    ...
    export class $Sheep extends $Animal implements $Shearable, $SheepAccessor {
        /**
        ...
        isSheared(): boolean;
        static createAttributes(): $AttributeSupplier$Builder;
        static invokeCreateSheepColor$polytone_$md$c99f8a$0(dyeColor: $DyeColor_): number;
        /**
        ...
        fluidHeight: $Object2DoubleMap<$TagKey<$Fluid>>;
        minorHorizontalCollision: boolean;
        static COLOR_BY_DYE: $Map<$DyeColor, number>;
        static LIVING_ENTITY_FLAG_IS_USING: number;
        bodyArmorDropChance: number;
        levelCallback: $EntityInLevelCallback;
        static EXTRA_RENDER_CULLING_SIZE_WITH_BIG_HAT: number;
