...
declare module "@package/net/mehvahdjukaar/polytone/slotify" {
     ...
     */
    export type $SimpleText_ = { z?: number, color?: number, y?: number, x?: number, centered?: boolean, text?: $Component_,  } | [z?: number, color?: number, y?: number, x?: number, centered?: boolean, text?: $Component_, ];
     ...
     */
    export type $SimpleSprite_ = { x?: number, height?: number, tooltip?: (string) | undefined, texture?: $ResourceLocation_, z?: number, y?: number, width?: number,  } | [x?: number, height?: number, tooltip?: (string) | undefined, texture?: $ResourceLocation_, z?: number, y?: number, width?: number, ];
     ...
     */
    export type $SpecialOffset_ = { z?: number, y?: number, x?: number,  } | [z?: number, y?: number, x?: number, ];
